    ...
    <main className="container app-page legal-page">
      <section className="dashboard-shell content-shell legal-shell app-page-stack" aria-label="Політика конфіденційності Mistblossom Vanguard">
        ...
        <article className="panel legal-card">
          ...
          <p>У роботі можуть використовуватися Discord, Battle.net, Firebase або інше сховище профілів, GitHub Issues для заявок, Cloudflare як проксі/CDN і власний сервер, на якому розгорнута панель. Кожен із цих сервісів може обробляти технічні дані згідно зі своїми правилами.</p>
