...
function getBattleNetCandidateTtlMs() {
  // Список персонажів Battle.net жив 3 хвилини — і це була головна
  // причина «не можу додати персонажа»: людина заходила через OAuth,
  // відволікалась, а блок «Можна додати» тихо зникав разом зі списком.
  // Щоб додати ще одного персонажа, треба було проходити авторизацію
  // заново, і ніде не було сказано чому.
  //
  // 30 хвилин — розумний компроміс: сесія не висить вічно, але встигає
  // пережити звичайну паузу. Значення й далі перекривається змінною
